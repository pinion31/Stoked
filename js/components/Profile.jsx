...
/* Displays profile of current user */
class Profile extends Component {
  ...
  /**
   *  makes API call to get current user information
   **/
  componentDidMount() {
    this.props.getUser();
  }
  ...
  /**
   *  After user edits information and clicks Finish Editing, information is verified for
   *  length. If verification passes, this function sends off updated
   *  info to db. Toggles Modal off.
   **/
  sendProfileEdit() {
    if (this.state.editedUser.name.length > 0 && this.state.editedUser.description.length > 0 &&
      this.state.editedUser.profilePic.length > 0) {
        this.props.editUser(this.state.editedUser);
        this.toggleModal();
    }  else {
      this.setState({
        errorMessage: 'Please fill out all information before submitting'
      })
    }
  }
  ...
  /**
   *  Used within modal to update profile pic of user.
   *
   **/
  onChangeImage() {
   ...
   /**
   * updates editedUser fields as user inputs info
